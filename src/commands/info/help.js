...
module.exports = {
    ...
    cooldown: 10000,
        ...
        const initialEmbed = new EmbedBuilder()
            .setTitle('Help page of CorlyBot 📚')
            .setURL('https://discord.gg/..')
            .setDescription('Below, you will find a menu with several categories that explains all of **my commands**. ⌚\n\n> If you have any questions about the bot, please join the [**CorlyBot\'s Server**](https://discord.com)')
            ...
            const buttonsRow = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
                        ...
                        .setURL('https://discord.com/oauth2/authorize?client_id=1250098225055137821&permissions=8&integration_type=0&scope=applications.commands+bot'),
                    new ButtonBuilder()
