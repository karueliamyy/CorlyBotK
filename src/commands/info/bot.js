...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        switch (subCommand) {
            ...
            case 'author': {
                const authorDescription = `Hey there, I'm **CorlyBot**! My developer/creator is **Vicii**. My goal is to liven up your server by bringing entertainment and good vibes, always ready to brighten your day ${emojis.love}`;
